...
Module['FS_createPath']("/", "fonts", true, true);
    ...
    loadPackage({"files": [{"filename": "/fonts/Cousine-Regular.ttf", "start": 151540, "end": 195452}, {"filename": "/fonts/DroidSans.ttf", "start": 195452, "end": 385496}, {"filename": "/fonts/Karla-Regular.ttf", "start": 385496, "end": 402344}, {"filename": "/fonts/ProggyClean.ttf", "start": 402344, "end": 443552}, {"filename": "/fonts/ProggyTiny.ttf", "start": 443552, "end": 479208}, {"filename": "/fonts/Roboto-Medium.ttf", "start": 479208, "end": 641796}, {"filename": "/fonts/binary_to_compressed_c.cpp", "start": 641796, "end": 657549}], "remote_package_size": 657549});

  })();

// end include: /tmp/tmpqpdndwke.js
// include: /tmp/tmpg5ya8rvk.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpg5ya8rvk.js
// include: /tmp/tmpspwj8vy6.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpspwj8vy6.js
...
var ASM_CONSTS = {
 ...
 343190: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 343273: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 343342: () => { return window.innerWidth; },  
 343372: () => { return window.innerHeight; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 290972;
